...
oval = c.create_oval(10,10,5,5, fill="red", outline="red")



ovalx = #*insert x position of where the oval should be* 
ovaly = #*insert y position of where the oval should be*

ovalcurrentx = 
ovalcurrenty = 


oval.moveto(ovalx - ovalcurrentx, ovaly - ovalcurrenty)

.place(x=joycirclecenterx,y=joycirclecentery)
